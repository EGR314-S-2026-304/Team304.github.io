...
|    Hafsa     |                A physical user interface is needed to turn on and off the telescope, adjust settings, alert user, and guarantee functionality if device is unable to establish WiFi connection.                   |
