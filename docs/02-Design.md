...
|5.|            Bi-Directional Communication               | 1.	Device can be used remotely <br> 2.	Device transmits data wirelessly through Bluetooth <br> 3.	Device can connect to local wifi= <br> 4.	Device can accept commands from user using Bluetooth or Wi-Fi <br> 5.	Device can transmit data collected to users in real time <br> 6.	Device can connect to GPS <br> 7.	Device supports software updates <br> 8.	Device can operate with low signal or offline <br> 9.	Device can transmit data to smart devices <br> 10.	Device has an app <br> 11.	Device can alert user of code errors <br> 12.	User can diagnose errors remotes            |
